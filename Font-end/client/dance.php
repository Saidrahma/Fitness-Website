			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Classes</h1>
				   					<h2><span><a href="index.php">Home</a> | <a href="classes.php">Classes</a> | Dance Classes</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 animate-box">
						<div class="classes">
              <div class="desc">
									<h1><a href="dance.php"> <strong>Dance</strong></a></h1>
									<?php
										for($i = 0; $i<count($data); $i++) {
								
									 if ($data[$i]['nameType']=='Dance'){
										 $ind = $i ; 
										 ?>
									 ...
									 ?> 
										...
										<div >
											<span>
												...
												<a href="belly_dance.php" ><img src="images/bellydance.png"></a>
									    </div>
												<a href="zumba.php" ><img src="images/zumbadance.png" > </a>
									      </br>
									  	</span>
										</div>
							</div>    
							<div class="classes-img classes-img-single"  style="background-image: url(images/dd.jpg)"></div>						
						</div>
