			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 animate-box">
						<div class="classes">
                                <div class="desc">
                                    <h1><a href="#"><strong> FITNESS </strong></a></h1>
                                        <?php
											for($i = 0; $i<count($data); $i++) {
											if ($data[$i]['nameType']=='Fitness'){
										 		$ind = $i ; 
										?>
                                        ...
                                        <div >
											<span>
												<div class="col-md-7 animate-box">
													...
													<a href="weight_loss.php"><img src="images/loose.png">  </a></br>
									    		</div>
												<a href="basic_exercice.php"><img src="images/basic.png" > </a></br>
											</span>
										</div>																		
                                </div>        
